// Shared treatment catalog for d'reena beauty — from the d'reena Treatment Programs 2026 menu.
// Categorised by skin type (matches the menu's own programs) for the Treatments page & Skin Quiz.
export const CATEGORIES = ["All Skin Types", "Acne-Prone Skin", "Aging Skin", "Sensitive Skin", "Pigmentation & Uneven Tone"];

export const TREATMENTS = [
  { slug: "teenskin", name: "TeenSkin Treatment", category: "All Skin Types", duration: "45 min", price: 108,
    concerns: ["acne", "oily"],
  ...
  { slug: "skin-boost", name: "SkinBoost Treatment", category: "All Skin Types", duration: "90 min", price: 153,
  ...
  { slug: "multivitamin-restore-rf", name: "Multivitamin Restore with RF", category: "All Skin Types", duration: "90-120 min", price: 318, newCustomerPrice: 159,
  ...
  { slug: "revive-glow", name: "Revive Glow Treatment", category: "All Skin Types", duration: "75 min", price: 248, newCustomerPrice: 124,
  ...
  { slug: "bio-cell", name: "Bio Cell Treatment", category: "All Skin Types", duration: "90 min", price: 398, newCustomerPrice: 199,
  ...
  { slug: "clear-matt", name: "Clear-Matt Treatment", category: "Acne-Prone Skin", duration: "60 min", price: 168,
    concerns: ["oily", "acne"],
  ...
  { slug: "pico-plus", name: "Pico Plus - Laser & Light Treatment", category: "Acne-Prone Skin", duration: "30-50 min", price: 238,
  ...
  { slug: "acr-treatment", name: "ACR Treatment", category: "Acne-Prone Skin", duration: "90 min", price: 398, newCustomerPrice: 199,
  ...
  { slug: "proclear", name: "ProClear Skin Treatment", category: "Acne-Prone Skin", duration: "90 min", price: 538, newCustomerPrice: 269,
    concerns: ["acne", "oily"],
  ...
  { slug: "caviar-restore", name: "Caviar Restore Treatment", category: "Aging Skin", duration: "90 min", price: 198, newCustomerPrice: 119,
  ...
  { slug: "glo2-facial", name: "Glo2 Facial Treatment", category: "Aging Skin", duration: "120 min", price: 368, newCustomerPrice: 184,
  ...
  { slug: "ionto-stem-cell", name: "IONTO Stem Cell Treatment", category: "Aging Skin", duration: "120 min", price: 638, newCustomerPrice: 319,
  ...
  { slug: "hifu", name: "HIFU - Ultratherapy", category: "Aging Skin", duration: "60-90 min", price: 738, newCustomerPrice: 398,
    concerns: ["aging"],
  ...
  { slug: "lumilift-elite", name: "LumiLift Elite", category: "Aging Skin", duration: "120 min", price: 698, newCustomerPrice: 349,
  ...
  { slug: "pro-lumin-fusion", name: "PRO Lumin Fusion", category: "Aging Skin", duration: "120 min", price: 558, newCustomerPrice: 279,
    concerns: ["aging", "dullness"],
  ...
  { slug: "environmental", name: "Environmental Treatment", category: "Sensitive Skin", duration: "120 min", price: 248, newCustomerPrice: 124,
  ...
  { slug: "oxygen", name: "Oxygen Treatment", category: "Sensitive Skin", duration: "120 min", price: 378, newCustomerPrice: 189,
  ...
  { slug: "pro-calm", name: "PRO Calm Treatment", category: "Sensitive Skin", duration: "120 min", price: 428, newCustomerPrice: 214,
  ...
  { slug: "whiteglow", name: "WhiteGlow Treatment", category: "Pigmentation & Uneven Tone", duration: "120 min", price: 508, newCustomerPrice: 254,
  ...
  { slug: "probright", name: "ProBright Skin Treatment with ProRestore", category: "Pigmentation & Uneven Tone", duration: "60 min", price: 588, newCustomerPrice: 294,
    concerns: ["pigmentation", "dullness"],
  ...
  { slug: "hollywood-peel", name: "Hollywood Peel Treatment", category: "Pigmentation & Uneven Tone", duration: "120 min", price: 428, newCustomerPrice: 214,
  ...
  { slug: "pico-laser", name: "Pico Laser with ProRestore", category: "Pigmentation & Uneven Tone", duration: "45 min", price: 698, newCustomerPrice: 398,
  ...
  { slug: "skin360", name: "Skin360 Photo Treatment", category: "Pigmentation & Uneven Tone", duration: "120 min", price: 438, newCustomerPrice: 219,
    concerns: ["pigmentation", "aging"],
...
// One representative treatment photo per category, sourced free-to-use from
// Unsplash. Unsplash's license permits this without attribution, but the
// image-slot component requires a visible credit for any Unsplash-hosted
// src, so each entry carries the photographer's name + profile link too.
export const CATEGORY_PHOTOS = {
  "All Skin Types": {
    photo: "https://images.unsplash.com/photo-1647004692483-c5d942fe1137?q=80&w=1200&auto=format&fit=crop",
    photoCredit: "Photo by Soheil Kmp on Unsplash",
    photoCreditHref: "https://unsplash.com/@soheilkmp",
  },
  "Acne-Prone Skin": {
    photo: "https://images.unsplash.com/photo-1761718210089-ba3bb5ccb54f?q=80&w=1200&auto=format&fit=crop",
    photoCredit: "Photo by kimia kazemi on Unsplash",
    photoCreditHref: "https://unsplash.com/@kimick",
  },
  "Aging Skin": {
    photo: "https://images.unsplash.com/photo-1713085085470-fba013d67e65?q=80&w=1200&auto=format&fit=crop",
    photoCredit: "Photo by Look Studio on Unsplash",
    photoCreditHref: "https://unsplash.com/@lookphoto",
  },
  "Sensitive Skin": {
    photo: "https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?q=80&w=1200&auto=format&fit=crop",
    photoCredit: "Photo by engin akyurt on Unsplash",
    photoCreditHref: "https://unsplash.com/@enginakyurt",
  },
  "Pigmentation & Uneven Tone": {
    photo: "https://images.unsplash.com/photo-1555820585-c5ae44394b79?q=80&w=1200&auto=format&fit=crop",
    photoCredit: "Photo by Sunny Ng on Unsplash",
    photoCreditHref: "https://unsplash.com/@sunnysmng",
  },
};

export function recommendFor(concerns) {
  const scored = TREATMENTS.map(t => ({
    t, score: t.concerns.filter(c => concerns.includes(c)).length
  }));
